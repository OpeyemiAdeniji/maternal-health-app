...
from .serializers import SupportResourcesResponseSerializer


class SupportResourcesView(APIView):
    permission_classes = [IsAuthenticated]
    serializer_class = SupportResourcesResponseSerializer

    @extend_schema(responses=SupportResourcesResponseSerializer)
